...
$(document).on('ready', function() {
    $('#boardSizeForm').on('submit', function(event) {
        ...
        function getCoordinates(arrayOfIds) {
        ...
        function countRows(playerCoordinates) {
            var yCoords = [];
        ...
        function countColumns(playerCoordinates) {
            var xCoords = [];
        ...
        function countPrimaryDiagonalCells(playerCoordinates) {
        ...
        function countSecondaryDiagonalCells(playerCoordinates) {
        ...
        function checkForWinningLines(rowCount, colCount, primaryDiagonalCount, secondaryDiagonalCount) {
            return (
        ...
        function checkWinner(gameBoardSize) {
        ...
        // Preventing "click" default action
        event.preventDefault();

    });


    // Creating gameBoard of given size
